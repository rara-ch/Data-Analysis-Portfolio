...
WITH  team_games AS (   -- Get each team and all their games with their score and their opponents scores (not including finals).
		SELECT 	 year, 
				 hometeam as Team, 
       ...
       tg_result AS ( 	-- Add a column that has the result of the team in the game.
...
team_performance AS (   -- Pivot the table so that it shows the win, loss, and draw percentage of each team in each year.
		SELECT	 year, team,
